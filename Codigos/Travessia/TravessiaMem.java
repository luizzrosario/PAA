...
class TravessiaMem {
  ...
  public static int D[][]; // Matriz para armazenar os calculos
  ...
  public static void main(String[] args) {
    try {
      ...
      // Definindo o tamanho da matriz onde ficarão os calculos
      D = new int[n][n];

      // Preenchendo a matriz de calculos com Max value para comparar depois
  ...
  public static int calcTravessia(int l, int c) {
    // Caso já tenha sido analisado em alguma outra vez
    if (D[l][c] != Integer.MAX_VALUE) {
      return D[l][c];
    }
    ...
    // Preenche na matriz o valor mínimo para o caminho até o [l][c];
    D[l][c] = Math.min(calcTravessia(l - 1, c) + Math.abs(M[l][c] - M[l - 1][c]),
